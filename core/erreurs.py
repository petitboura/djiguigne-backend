...
MESSAGES_FR: dict[str, str] = {
    ...
    # Contenu pratique du programme étudiant -- lot 2/5 (2026-08-12)
    # (PROGRAMME_INTROUVABLE et CHAPITRE_INTROUVABLE déjà définis par le lot 1 ci-dessus, réutilisés tels quels)
    "PAS_LE_DROIT_SUR_CE_CHAPITRE": "Tu n'as pas le droit sur ce chapitre.",
    "PAS_LE_DROIT_SUR_CE_PROGRAMME": "Tu n'as pas le droit sur ce programme.",
    "DOCUMENT_PROGRAMME_INTROUVABLE": "Document introuvable.",
    "TITRE_DOCUMENT_REQUIS": "Le document doit avoir un titre.",
    "CONTENU_DOCUMENT_REQUIS": "Le document doit avoir un contenu ou une URL.",
    "EXERCICE_INTROUVABLE": "Exercice introuvable.",
    "ENONCE_REQUIS": "L'énoncé ne peut pas être vide.",
    "IMPOSSIBLE_DE_LISTER_LES_EXERCICES_POUR": "Impossible de lister les exercices pour le moment.",
    "IMPOSSIBLE_D_AJOUTER_CET_EXERCICE_POUR": "Impossible d'ajouter cet exercice pour le moment.",
    "IMPOSSIBLE_DE_MODIFIER_CET_EXERCICE_POUR": "Impossible de modifier cet exercice pour le moment.",
    "IMPOSSIBLE_DE_SUPPRIMER_CET_EXERCICE_POUR": "Impossible de supprimer cet exercice pour le moment.",
    "EXAMEN_INTROUVABLE": "Examen introuvable.",
    "PAS_LE_DROIT_SUR_CET_EXAMEN": "Tu n'as pas le droit sur cet examen.",
    "TITRE_EXAMEN_REQUIS": "L'examen doit avoir un titre.",
    "CHAPITRE_IDS_REQUIS": "Sélectionne au moins un chapitre.",
    "IMPOSSIBLE_DE_LISTER_LES_EXAMENS_POUR": "Impossible de lister les examens pour le moment.",
    "IMPOSSIBLE_DE_CREER_CET_EXAMEN_POUR": "Impossible de créer cet examen pour le moment.",
    "IMPOSSIBLE_DE_MODIFIER_CET_EXAMEN_POUR": "Impossible de modifier cet examen pour le moment.",
    "IMPOSSIBLE_DE_SUPPRIMER_CET_EXAMEN_POUR": "Impossible de supprimer cet examen pour le moment.",
    "CLASSEMENT_INTROUVABLE": "Classement introuvable.",
    "PAS_LE_DROIT_SUR_CE_CLASSEMENT": "Tu n'as pas le droit sur ce classement.",
    "LABEL_CLASSEMENT_REQUIS": "Le classement doit avoir un nom.",
    "IMPOSSIBLE_DE_LISTER_LES_CLASSEMENTS_POUR": "Impossible de lister les classements pour le moment.",
    "IMPOSSIBLE_DE_CREER_CE_CLASSEMENT_POUR": "Impossible de créer ce classement pour le moment.",
    "IMPOSSIBLE_DE_SUPPRIMER_CE_CLASSEMENT_POUR": "Impossible de supprimer ce classement pour le moment.",
    "CIBLE_INTROUVABLE": "L'élément à classer est introuvable.",
    "PAS_LE_DROIT_SUR_CETTE_CIBLE": "Tu n'as pas le droit sur cet élément.",
    "IMPOSSIBLE_D_AJOUTER_CET_ELEMENT_AU": "Impossible d'ajouter cet élément au classement pour le moment.",
    "CLASSEMENT_ITEM_INTROUVABLE": "Cet élément ne fait pas partie de ce classement.",
